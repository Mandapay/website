...
2. Clients and General Pictures
...
A: You can use template.html to easily create a new Paperclip page for your website. 
   Navigation panel, footer and other default assets are already included into them.